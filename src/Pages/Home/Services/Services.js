    ...
    return (
        <div className='my-20'>
            <div className='text-center'>
                <h3 className='text-xl font-bold uppercase text-primary mb-3'>Our Services</h3>
            ...
            <div class="hero w-11/12 mx-auto mt-5">
                <div class="hero-content flex-col lg:flex-row p-0 m-0">
                    ...
                    <div className='ml-20'>
                        ...
                        <button class="btn btn-primary bg-gradient-to-r from-secondary to-primary text-white font-bold uppercase">Get Started</button>
                    </div>
                </div>
            </div>
        </div>
